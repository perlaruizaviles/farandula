      ...
      class TravelportFlightManager < FlightManager
        ...
        def parse_response response
          ...
          segment_node_list.each do |segment_node|
            ...
            segment.marketing_airline_code = segment_node.attr('Carrier')
            segment.operating_airline_code = code_share_info.attr('OperatingCarrier').to_s
            segment.operating_flight_number = code_share_info.attr('OperatingFlightNumber').to_s
