module Farandula
  ...
  class Farandula::SabreIntegrationTest < Minitest::Test
    ...
    def test_round_trip
      ...
      assert_equal itineraries[0].air_legs[0].departure_airport_code, from[0]
      assert_equal itineraries[0].air_legs[0].arrival_airport_code, to[0]
      assert_equal itineraries[0].air_legs[1].arrival_airport_code, from[0]
      assert_equal itineraries[0].air_legs[1].departure_airport_code, to[0]
      assert_equal itineraries[0].air_legs.size , 2
    ...
    def test_open_jow
      ...
      assert_equal itineraries[0].air_legs[0].departure_airport_code, from[0]
      assert_equal itineraries[0].air_legs[0].arrival_airport_code, to[0]
      assert_equal itineraries[0].air_legs[1].departure_airport_code, from[1]
      assert_equal itineraries[0].air_legs[1].arrival_airport_code, to[1]
      assert_equal itineraries[0].air_legs.size , 2
  ...
  def test_open_jow_diff_passengers
    ...
    itineraries = manager.get_avail(search_form)
    assert itineraries.size <= limit
    assert_equal itineraries[0].air_legs.size , 3
    assert_equal itineraries[0].air_legs[0].departure_airport_code, from[0]
    assert_equal itineraries[0].air_legs[0].arrival_airport_code, to[0]
    assert_equal itineraries[0].air_legs[1].departure_airport_code, from[1]
    assert_equal itineraries[0].air_legs[1].arrival_airport_code, to[1]
    assert_equal itineraries[0].air_legs[2].departure_airport_code, from[2]
    assert_equal itineraries[0].air_legs[2].arrival_airport_code, to[2]
  end
